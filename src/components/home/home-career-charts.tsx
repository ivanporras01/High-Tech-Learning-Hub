...
export function HomeCareerCharts() {
  const salaryData = {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      <div className="qwa-glass-card">
        <div className="h-72" role="img" aria-label="Bar chart of quantum career salary ranges">
          <Bar
            data={salaryData}
            options={{
              responsive: true,
              ...
              plugins: {
                legend: { position: "top" },
                title: { display: true, text: "Quantum Role Salary Ranges (USD thousands / year)" },
              },
              scales: { y: { beginAtZero: true, title: { display: true, text: "$ thousands" } } },
            }}
          />
        </div>
      </div>
      <div className="qwa-glass-card">
        <div className="h-64" role="img" aria-label="Doughnut chart of quantum role distribution">
          <Doughnut
            data={roleData}
            options={{
              responsive: true,
